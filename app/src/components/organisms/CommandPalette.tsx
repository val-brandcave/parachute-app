...
const NAV: { label: string; href: string; icon: IconName }[] = [
  ...
  { label: "Workbook layouts", href: "/configure/workbook-layouts", icon: "templates" },
  { label: "Response library", href: "/configure/responses", icon: "quote" },
  { label: "Org workbook layout", href: "/configure/workbook-layouts/view", icon: "book" },
