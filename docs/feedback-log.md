...
| F-003 | early (pre-Jun 23) | Cody | Review Details | Review findings **from the context of the PDF, with annotations** — Ashore-style. You can't tell *where* a finding sits in the document otherwise. | **Yes** — re-raised Jun 23 as "ignored or forgotten" | 🔵→🟡 | **Decision (Jun 30): PDF is primary; Ashore-pin model replaces focus-mode.** Build held for Cody's wireframes (F-104). Ref: https://sea.ashoreapp.com |
